...
namespace ClearServer {
    ...
    public partial class UsersDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsersRow AddUsersRow(string login, string password, string name, string city, string date, string skills) {
        ...
        public partial class UsersRow : global::System.Data.DataRow {
            ...
            public string skills {
                get {
                    try {
                        return ((string)(this[this.tableUsers.skillsColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'skills\' в таблице \'Users\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableUsers.skillsColumn] = value;
                }
            }
            ...
            public bool IsskillsNull() {
                return this.IsNull(this.tableUsers.skillsColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetskillsNull() {
                this[this.tableUsers.skillsColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace ClearServer.UsersDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Users] WHERE (([uid] = @Original_uid) AND ([login] = @Original_login) AND ([password] = @Original_password) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_city = 1 AND [city] IS NULL) OR ([city] = @Original_city)) AND ((@IsNull_date = 1 AND [date] IS NULL) OR ([date] = @Original_date)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([login], [password], [name], [city], [date], [skills])" +
                " VALUES (@login, @password, @name, @city, @date, @skills);\r\nSELECT uid, login, p" +
                "assword, name, city, date, skills FROM Users WHERE (uid = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [login] = @login, [password] = @password, [name] = @name, [city] = @city, [date] = @date, [skills] = @skills WHERE (([uid] = @Original_uid) AND ([login] = @Original_login) AND ([password] = @Original_password) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_city = 1 AND [city] IS NULL) OR ([city] = @Original_city)) AND ((@IsNull_date = 1 AND [date] IS NULL) OR ([date] = @Original_date)));
SELECT uid, login, password, name, city, date, skills FROM Users WHERE (uid = @uid)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ClearServer.Properties.Settings.Default.UsersConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT uid, login, password, name, city, date, skills FROM dbo.Users";
        ...
        public virtual int Delete(int Original_uid, string Original_login, string Original_password, string Original_name, string Original_city, string Original_date) {
        ...
        public virtual int Insert(string login, string password, string name, string city, string date, string skills) {
            if ((login == null)) {
        ...
        public virtual int Update(string login, string password, string name, string city, string date, string skills, int Original_uid, string Original_login, string Original_password, string Original_name, string Original_city, string Original_date, int uid) {
            if ((login == null)) {
                throw new global::System.ArgumentNullException("login");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[15].Value = ((int)(uid));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string login, string password, string name, string city, string date, string skills, int Original_uid, string Original_login, string Original_password, string Original_name, string Original_city, string Original_date) {
            return this.Update(login, password, name, city, date, skills, Original_uid, Original_login, Original_password, Original_name, Original_city, Original_date, Original_uid);
        }
    }
